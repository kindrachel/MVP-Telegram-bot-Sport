...
from database import User, Organization, get_session, UserRole, Challenge
...
async def show_admin_menu(message: types.Message):
    ...
    if effective_role == UserRole.SUPER_ADMIN.value:
        kb = InlineKeyboardMarkup(inline_keyboard=[
            [InlineKeyboardButton(text="🏢 Выбрать клуб", callback_data="admin_select_organization")],
            ...
            [InlineKeyboardButton(text="📢 Глобальная рассылка", callback_data="admin_global_broadcast")],
        ...
        kb = InlineKeyboardMarkup(inline_keyboard=[
            ...
            [InlineKeyboardButton(text="👥 Управление игроками", callback_data="admin_manage_members")],
        ...
        kb = InlineKeyboardMarkup(inline_keyboard=[
            [InlineKeyboardButton(text="⚡ Создать челлендж", callback_data="admin_select_org")],
            [InlineKeyboardButton(text="📊 Статистика команды", callback_data="admin_view_stats")],
            [InlineKeyboardButton(text="👥 Просмотр игроков", callback_data="admin_manage_members")],
            [InlineKeyboardButton(text="🏆 Лидерборд", callback_data="admin_leaderboard")],
...
async def member_detail(callback: types.CallbackQuery) -> None:
    ...
    try:
        ...
        kb_buttons.extend([
            [InlineKeyboardButton(text="⚡ Челленджи", callback_data=f"admin_member_challenges_{member.id}")],
...
@router.callback_query(F.data.startswith("admin_member_challenges_"))
async def superadmin_member_challenges(callback: types.CallbackQuery):
    ...
    member_id = int(callback.data.replace("admin_member_challenges_", ""))
    ...
    try:
        ...
        for place in leaderboard:
            ...
            text += (
                ...
                f"   💎 {place['points']} баллов | {place['position_role']}\n"
            )
