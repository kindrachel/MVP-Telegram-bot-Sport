...
async def admin_view_stats(callback: types.CallbackQuery) -> None:
    ...
    try:
        ...
        stats_text = (
            ...
            f"💎 Всего баллов в команде: {stats['total_points']}\n\n"
...
*Уровень:* {user_data['level']} | *Баллы:* {user_data['points']}
    ...
    try:
        ...
        await callback.bot.send_document(
            ...
            caption=(
                ...
                f"*баллов заработано:* {sum(m['user_data'].get('points', 0) for m in report.get('member_reports', [])):,}\n\n"
