...
@router.callback_query(F.data == 'org_admin_cancel_timezone')
...
@router.callback_query(F.state.in_([TimezoneStates.waiting_timezone, TimezoneStates.waiting_confirmation]),
