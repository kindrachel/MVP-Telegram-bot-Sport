...
• Награда: {challenge_data['points']} баллов
...
async def complete_challenge(message: Message, state: FSMContext):
    ...
    try:
        ...
        if challenge_id:
            ...
            if challenge:
                # Обновляем статус и добавляем Баллы
                ...
                if user:
                    ...
                    # Проверяем повышение уровня (например, каждые 100 баллов)
