...
async def admin_show_vacancies_intro(message: types.Message) -> None:
    """Показать интро вакансий для админов"""
    ...
    try:
        ...
        if not vacancies:
            await message.answer("❌ Нет доступных вакансий", show_alert=True)
            return
        ...
        await message.answer (intro_text, parse_mode = 'Markdown', reply_markup=vacancies_menu_keyboard())
