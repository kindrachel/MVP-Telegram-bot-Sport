        ...
        try:
            ...
            for user in users:
                try:
                    ...
                    # Подсчитываем Баллы, заработанные сегодня
            ...
            Заработано баллов: {report_data['daily_stats']['total_points_earned']}
    ...
    async def generate_detailed_member_report(self, org_id: int) -> Dict:
        ...
        try:
            ...
            try:
                ...
                - Средние Баллы: {sum(getattr(u, 'points', 0) for u in users) / len(users):.1f}
